...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.buttons           = self.buttons           || $parent.attr("data-buttons");
    });
    ...
    self.buttons           = self.element.attr("data-buttons")             || self.buttons || false;
...
BestInPlaceEditor.forms = {
  "input" : {
    activateForm : function() {
      ...
      if(this.buttons) {
        output.append(
          '<ul class="button-group"><li><button type="submit"><span class="icon-check"></span></button></li><li><button type="button"><span class="icon-cancel"></span></button></li></ul>';
        )
      }
