    ...
    activateForm : function() {
      ...
      output.append(
        $('<div/>', {'class': 'row collapse'}).append(
          $('<div/>', {'class': 'small-8 large-10 columns'}).append(
            input_elt
          )
        ).append(
          $('<div/>', {'class': 'small-2 large-1 columns'}).append(
            $('<button/>', {'type': 'submit', 'class': 'button midfix' }).append(
              $('<span/>', {'class': 'icon-check'})
            )
          )
        ).append(
          $('<div/>', {'class': 'small-2 large-1 columns'}).append(
            $('<button/>', {'type': 'button', 'class': 'button postfix'}).append(
